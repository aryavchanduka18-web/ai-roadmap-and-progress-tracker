    ...
    topics: [
      {
        ...
        subtopics: [
          { id: 'w1-mon', title: 'Mon — Vectors, dot product, vector addition', hours: 1.5, priority: 'must-know', weekNumber: 1, resources: [{ type: 'youtube', label: '3B1B Linear Algebra — Ep 1: Vectors, what even are they?', url: 'https://www.youtube.com/watch?v=fNk_zzaMoSs' }, { type: 'youtube', label: '3B1B Linear Algebra — Ep 2: Linear combinations, span, basis', url: 'https://www.youtube.com/watch?v=k7RM-ot2NWY' }] },
          { id: 'w1-tue', title: 'Tue — Linear combinations, span, basis vectors', hours: 1.5, priority: 'must-know', weekNumber: 1, resources: [{ type: 'youtube', label: '3B1B Linear Algebra — Ep 3: Linear transformations and matrices', url: 'https://www.youtube.com/watch?v=kYB8IZa5AuE' }, { type: 'youtube', label: '3B1B Linear Algebra — Ep 4: Matrix multiplication as composition', url: 'https://www.youtube.com/watch?v=XkY2DOUCWMU' }] },
          { id: 'w1-wed', title: 'Wed — Matrix transformations', hours: 1.5, priority: 'must-know', weekNumber: 1, resources: [{ type: 'youtube', label: '3B1B Linear Algebra — Ep 5: Three-dimensional linear transformations', url: 'https://www.youtube.com/watch?v=rHLEWRxRGiM' }, { type: 'youtube', label: '3B1B Linear Algebra — Ep 6: The determinant', url: 'https://www.youtube.com/watch?v=Ip3X9LOh2dk' }] },
          { id: 'w1-thu', title: 'Thu — Matrix multiplication, 3D transformations', hours: 1.5, priority: 'must-know', weekNumber: 1, resources: [{ type: 'youtube', label: '3B1B Linear Algebra — Ep 7: Inverse matrices, column space, null space', url: 'https://www.youtube.com/watch?v=uQhTuRlWMxw' }, { type: 'youtube', label: '3B1B Linear Algebra — Ep 8: Nonsquare matrices as transformations', url: 'https://www.youtube.com/watch?v=v8VSDg_WQlA' }] },
          { id: 'w1-fri', title: 'Fri — Determinants, inverse matrices', hours: 1.5, priority: 'must-know', weekNumber: 1, resources: [{ type: 'youtube', label: '3B1B Linear Algebra — Ep 9: Dot products and duality', url: 'https://www.youtube.com/watch?v=LyGKycYT2v0' }, { type: 'youtube', label: '3B1B Linear Algebra — Ep 10: Cross products', url: 'https://www.youtube.com/watch?v=eu6i7WJeinw' }] },
          { id: 'w1-sat', title: 'Sat — Eigenvectors & eigenvalues, SVD intuition', hours: 3, priority: 'must-know', weekNumber: 1, resources: [{ type: 'youtube', label: '3B1B Linear Algebra — Ep 14: Eigenvectors and eigenvalues', url: 'https://www.youtube.com/watch?v=PFDu9oVAE-g' }, { type: 'youtube', label: '3B1B Linear Algebra — Ep 11: Cross products via linear transformations', url: 'https://www.youtube.com/watch?v=BaM7OCEm3G0' }, { type: 'youtube', label: '3B1B — A quick trick for computing eigenvalues', url: 'https://www.youtube.com/watch?v=e50Bj7jn9IQ' }] },
      ...
      },
      {
        ...
        subtopics: [
          { id: 'w2-mon', title: 'Mon — Derivatives, geometric meaning', hours: 1.5, priority: 'must-know', weekNumber: 2, resources: [{ type: 'youtube', label: '3B1B Calculus — Ep 1: The essence of calculus', url: 'https://www.youtube.com/watch?v=WUvTyaaNkzM' }, { type: 'youtube', label: '3B1B Calculus — Ep 2: The paradox of the derivative', url: 'https://www.youtube.com/watch?v=9vKqVkMQHKk' }, { type: 'youtube', label: '3B1B Calculus — Ep 3: Derivative formulas through geometry', url: 'https://www.youtube.com/watch?v=S0_qX4VJhMQ' }] },
          { id: 'w2-tue', title: 'Tue — Chain rule (THIS IS BACKPROP)', hours: 1.5, priority: 'must-know', weekNumber: 2, resources: [{ type: 'youtube', label: '3B1B Calculus — Ep 4: Visualizing the chain rule and product rule (watch twice)', url: 'https://www.youtube.com/watch?v=YG15m2VwSjA' }] },
          ...
          { id: 'w2-thu', title: 'Thu — Probability basics, random variables, expectation, variance', hours: 1.5, priority: 'must-know', weekNumber: 2, resources: [{ type: 'youtube', label: 'StatQuest: Probability is not Likelihood', url: 'https://www.youtube.com/watch?v=pYxNSUDSFH4' }, { type: 'youtube', label: 'StatQuest: Expected Values, Main Ideas', url: 'https://www.youtube.com/watch?v=KLs_7b7SKi4' }] },
          { id: 'w2-fri', title: 'Fri — Distributions: Bernoulli, Gaussian, Categorical', hours: 1.5, priority: 'must-know', weekNumber: 2, resources: [{ type: 'youtube', label: 'StatQuest: The Normal Distribution, Clearly Explained', url: 'https://www.youtube.com/watch?v=rzFX5NWojp0' }, { type: 'youtube', label: 'StatQuest: The Binomial Distribution', url: 'https://www.youtube.com/watch?v=8idr1WZ1A7Q' }] },
          { id: 'w2-sat', title: 'Sat — Bayes Theorem + conditional probability', hours: 3, priority: 'must-know', weekNumber: 2, resources: [{ type: 'youtube', label: 'StatQuest: Bayes Theorem, Clearly Explained!', url: 'https://www.youtube.com/watch?v=9wCnvr7Xw4E' }] },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { id: 'w3-wed', title: 'Wed — Pandas: DataFrames, filtering, groupby, merge', hours: 1.5, priority: 'must-know', weekNumber: 3, resources: [{ type: 'youtube', label: 'Corey Schafer: Pandas Tutorial Ep 1 — Installation and Loading Data', url: 'https://www.youtube.com/watch?v=ZyhVh-qRZPA' }, { type: 'youtube', label: 'Corey Schafer: Pandas Tutorial Ep 2 — DataFrame and Series Basics', url: 'https://www.youtube.com/watch?v=zmdjNSmRXF4' }] },
          { id: 'w3-thu', title: 'Thu — Pandas continued: pivot, time series, missing data', hours: 1.5, priority: 'must-know', weekNumber: 3, resources: [{ type: 'youtube', label: 'Corey Schafer: Pandas Tutorial Ep 5 — Updating Rows and Columns', url: 'https://www.youtube.com/watch?v=DCDe29sIKcE' }, { type: 'youtube', label: 'Corey Schafer: Pandas Tutorial Ep 7 — Time Series Data', url: 'https://www.youtube.com/watch?v=UFuo7EHI8zc' }] },
          { id: 'w3-fri', title: 'Fri — Matplotlib + Seaborn', hours: 1.5, priority: 'must-know', weekNumber: 3, resources: [{ type: 'youtube', label: 'Corey Schafer: Matplotlib Tutorial Ep 1 — Creating and Customizing Plots', url: 'https://www.youtube.com/watch?v=UO98lJQ3QGI' }] },
          { id: 'w3-sat', title: 'Sat — Git/GitHub: branches, commits, PRs, .gitignore', hours: 3, priority: 'must-know', weekNumber: 3, resources: [{ type: 'youtube', label: 'Corey Schafer: Git Tutorial Ep 1 — What is Git and why use it', url: 'https://www.youtube.com/watch?v=HVsySz-h9r4' }, { type: 'youtube', label: 'Corey Schafer: Git Tutorial Ep 2 — Installation and first commit', url: 'https://www.youtube.com/watch?v=8JJ101D3knE' }] },
      ...
      },
      {
        ...
        subtopics: [
          { id: 'w5-mon', title: 'Mon — Decision Trees: entropy, Gini', hours: 1.5, priority: 'must-know', weekNumber: 5, resources: [{ type: 'youtube', label: 'StatQuest: Decision and Classification Trees, Clearly Explained!', url: 'https://www.youtube.com/watch?v=_L39rN6gz7Y' }, { type: 'course', label: 'Andrew Ng Course 2, Week 4', url: 'https://www.coursera.org/specializations/machine-learning-introduction' }] },
          { id: 'w5-tue', title: 'Tue — Random Forests + bagging', hours: 1.5, priority: 'must-know', weekNumber: 5, resources: [{ type: 'youtube', label: 'StatQuest: Random Forests Part 1 — Building, Using and Evaluating', url: 'https://www.youtube.com/watch?v=J4Wdy0Wc_xQ' }, { type: 'youtube', label: 'StatQuest: Random Forests Part 2 — Missing data & Sample Clustering', url: 'https://www.youtube.com/watch?v=sQ870aTKqiM' }] },
          { id: 'w5-wed', title: 'Wed — Gradient Boosting intuition', hours: 1.5, priority: 'must-know', weekNumber: 5, resources: [{ type: 'youtube', label: 'StatQuest: Gradient Boost Part 1 — Regression Main Ideas', url: 'https://www.youtube.com/watch?v=3CC4N4z3GJc' }] },
          { id: 'w5-thu', title: 'Thu — XGBoost + LightGBM hands-on', hours: 1.5, priority: 'must-know', weekNumber: 5, resources: [{ type: 'youtube', label: 'StatQuest: XGBoost Part 1 — XGBoost Trees for Regression', url: 'https://www.youtube.com/watch?v=OtD8wVaFm6E' }, { type: 'doc', label: 'XGBoost Quick Start docs', url: 'https://xgboost.readthedocs.io/en/stable/get_started.html' }] },
      ...
      },
      {
        ...
        subtopics: [
          { id: 'w6-mon', title: 'Mon — Why accuracy misleads. Precision, Recall, F1', hours: 1.5, priority: 'must-know', weekNumber: 6, resources: [{ type: 'youtube', label: 'StatQuest: Sensitivity and Specificity, Clearly Explained!', url: 'https://www.youtube.com/watch?v=vP06aMoz4v8' }, { type: 'youtube', label: 'StatQuest: Precision vs Recall', url: 'https://www.youtube.com/watch?v=8d3JbbSj-I8' }] },
          { id: 'w6-tue', title: 'Tue — ROC, AUC, PR curves', hours: 1.5, priority: 'must-know', weekNumber: 6, resources: [{ type: 'youtube', label: 'StatQuest: ROC and AUC, Clearly Explained!', url: 'https://www.youtube.com/watch?v=4jRBRDbJemM' }] },
          { id: 'w6-wed', title: 'Wed — k-fold + stratified cross-validation', hours: 1.5, priority: 'must-know', weekNumber: 6, resources: [{ type: 'youtube', label: 'StatQuest: Machine Learning Fundamentals — Cross Validation', url: 'https://www.youtube.com/watch?v=fSytzGwwBVw' }] },
    ...
    topics: [
      {
        ...
        subtopics: [
          { id: 'w9-mon', title: 'Mon — Karpathy "Neural Networks: Zero to Hero" — Episode 1: micrograd Part 1', hours: 2, priority: 'must-know', weekNumber: 9, resources: [{ type: 'youtube', label: 'Karpathy Ep 1: Building micrograd — spelled-out intro to neural nets + backprop', url: 'https://www.youtube.com/watch?v=VMj-3S1tku0' }] },
          { id: 'w9-tue', title: 'Tue — Episode 1 continued — code along', hours: 2, priority: 'must-know', weekNumber: 9, resources: [{ type: 'youtube', label: 'Karpathy Ep 1: Building micrograd', url: 'https://www.youtube.com/watch?v=VMj-3S1tku0' }] },
          { id: 'w9-wed', title: 'Wed — Finish micrograd, internalize backprop fully', hours: 1.5, priority: 'must-know', weekNumber: 9, resources: [{ type: 'youtube', label: 'Karpathy Ep 1: Building micrograd', url: 'https://www.youtube.com/watch?v=VMj-3S1tku0' }] },
          { id: 'w9-thu', title: 'Thu — Karpathy Episode 2: makemore (bigram model)', hours: 1.5, priority: 'must-know', weekNumber: 9, resources: [{ type: 'youtube', label: 'Karpathy Ep 2: Building makemore (bigram language model)', url: 'https://www.youtube.com/watch?v=PaCmpygFfXo' }] },
          { id: 'w9-fri', title: 'Fri — Episode 2 continued', hours: 1.5, priority: 'must-know', weekNumber: 9, resources: [{ type: 'youtube', label: 'Karpathy Ep 2: Building makemore (bigram language model)', url: 'https://www.youtube.com/watch?v=PaCmpygFfXo' }] },
          { id: 'w9-sat', title: 'Sat — Karpathy Episode 3: MLP (full 3-hour video)', hours: 3, priority: 'must-know', weekNumber: 9, resources: [{ type: 'youtube', label: 'Karpathy Ep 3: Building makemore Part 2 — MLP (full 3-hour deep dive)', url: 'https://www.youtube.com/watch?v=TCH_1BHY58I' }] },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { id: 'w10-sat', title: 'Sat — Batch norm vs Layer norm (mandatory interview topic)', hours: 3, priority: 'must-know', weekNumber: 10, resources: [{ type: 'course', label: 'Andrew Ng Course 2, Week 3', url: 'https://www.coursera.org/specializations/deep-learning' }, { type: 'youtube', label: 'Karpathy Ep 3: Activations & Gradients, BatchNorm (definitive 1h walk-through)', url: 'https://www.youtube.com/watch?v=P6sfmUTpUmc' }] },
      ...
      },
      {
        ...
        subtopics: [
          { id: 'w12-mon', title: 'Mon — What is convolution? Filters, stride, padding', hours: 1.5, priority: 'must-know', weekNumber: 12, resources: [{ type: 'youtube', label: 'CS231n 2017 — Lecture 5: Convolutional Neural Networks', url: 'https://www.youtube.com/watch?v=bNb2fEVKeEo' }] },
          { id: 'w12-tue', title: 'Tue — Pooling, receptive field', hours: 1.5, priority: 'must-know', weekNumber: 12, resources: [{ type: 'youtube', label: 'CS231n 2017 — Lecture 5: CNNs (continued, pooling + receptive fields)', url: 'https://www.youtube.com/watch?v=bNb2fEVKeEo' }] },
          { id: 'w12-wed', title: 'Wed — CNN architectures: LeNet, AlexNet, VGG', hours: 1.5, priority: 'must-know', weekNumber: 12, resources: [{ type: 'youtube', label: 'CS231n 2017 — Lecture 9: CNN Architectures (LeNet, AlexNet, VGG, ResNet)', url: 'https://www.youtube.com/watch?v=DAOcjicFr1Y' }] },
          { id: 'w12-thu', title: 'Thu — ResNet + residual connections (critical)', hours: 1.5, priority: 'must-know', weekNumber: 12, resources: [{ type: 'youtube', label: 'CS231n 2017 — Lecture 9: ResNet + residual connections (continued)', url: 'https://www.youtube.com/watch?v=DAOcjicFr1Y' }] },
      ...
      },
      {
        ...
        subtopics: [
          { id: 'w13-mon', title: 'Mon — Tokenization basics: characters, words, subwords', hours: 1.5, priority: 'must-know', weekNumber: 13, resources: [{ type: 'youtube', label: 'CS224n 2023 — Lecture 1: Introduction and Word Vectors', url: 'https://www.youtube.com/watch?v=rmVRLeJRkl4' }] },
          ...
          { id: 'w13-thu', title: 'Thu — Word2Vec, GloVe (legacy but interview-relevant)', hours: 1.5, priority: 'must-know', weekNumber: 13, resources: [{ type: 'youtube', label: 'CS224n 2023 — Lecture 2: Neural Classifiers (Word2Vec, GloVe)', url: 'https://www.youtube.com/watch?v=gqaHkPEZAew' }] },
          ...
          { id: 'w13-sat', title: 'Sat — RNN basics + why they failed → motivation for Transformers', hours: 3, priority: 'must-know', weekNumber: 13, resources: [{ type: 'youtube', label: 'CS224n 2023 — Lecture 5: Recurrent Neural Networks', url: 'https://www.youtube.com/watch?v=X1HKxQDOPLE' }] },
          { id: 'w13-sun', title: 'Sun — LSTM + vanishing gradients (interview topic)', hours: 3, priority: 'must-know', weekNumber: 13, resources: [{ type: 'youtube', label: 'CS224n 2023 — Lecture 6: Sequence to Sequence (LSTM + attention)', url: 'https://www.youtube.com/watch?v=wzfWHP6SXxY' }] },
        ],
      },
      {
        id: 'w14',
        ...
        subtopics: [
          ...
          { id: 'w14-sun', title: 'Sun — KV cache, Pre-LN vs Post-LN (interview topics)', hours: 2.5, priority: 'must-know', weekNumber: 14, resources: [{ type: 'article', label: "Sebastian Raschka: Understanding and Coding the KV Cache in LLMs from Scratch", url: 'https://magazine.sebastianraschka.com/p/coding-the-kv-cache-in-llms' }, { type: 'article', label: "Sebastian Raschka: Pre-LN vs Post-LN in Transformers (Ahead of AI)", url: 'https://magazine.sebastianraschka.com/p/understanding-large-language-models' }] },
        ],
      },
      {
        id: 'w15',
    ...
    topics: [
      {
        ...
        subtopics: [
          { id: 'w17-mon', title: 'Mon — System/User/Assistant structure, OpenAI API basics, async API calls', hours: 1.5, priority: 'must-know', weekNumber: 17, resources: [{ type: 'doc', label: 'OpenAI Quickstart: Chat Completions API', url: 'https://platform.openai.com/docs/quickstart' }, { type: 'doc', label: 'OpenAI Cookbook: How to use the Chat Completions API', url: 'https://cookbook.openai.com/examples/how_to_format_inputs_to_chatgpt_models' }] },
          { id: 'w17-tue', title: 'Tue — Anthropic API + Claude vision API (multimodal bonus)', hours: 1.5, priority: 'must-know', weekNumber: 17, resources: [{ type: 'doc', label: 'Anthropic: Getting started with the API', url: 'https://docs.anthropic.com/en/api/getting-started' }, { type: 'doc', label: 'Anthropic: Vision (multimodal image inputs)', url: 'https://docs.anthropic.com/en/docs/build-with-claude/vision' }] },
          { id: 'w17-wed', title: 'Wed — Few-shot prompting, chain-of-thought, self-consistency, ReAct', hours: 1.5, priority: 'must-know', weekNumber: 17, resources: [{ type: 'doc', label: 'Anthropic: Prompt Engineering Overview', url: 'https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview' }, { type: 'doc', label: 'Anthropic: Chain of Thought prompting', url: 'https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/chain-of-thought' }] },
          { id: 'w17-thu', title: 'Thu — Structured output: JSON mode, function calling', hours: 1.5, priority: 'must-know', weekNumber: 17, resources: [{ type: 'doc', label: 'OpenAI: Structured Outputs (JSON mode)', url: 'https://platform.openai.com/docs/guides/structured-outputs' }, { type: 'doc', label: 'OpenAI: Function calling', url: 'https://platform.openai.com/docs/guides/function-calling' }] },
      ...
      },
      {
        ...
        subtopics: [
          { id: 'w18-mon', title: 'Mon — What is RAG? Why it exists. RAG vs fine-tuning decision', hours: 1.5, priority: 'must-know', weekNumber: 18, resources: [{ type: 'doc', label: 'LangChain: RAG concepts (what + why)', url: 'https://python.langchain.com/docs/concepts/rag/' }, { type: 'article', label: 'Pinecone Learn: RAG vs Fine-tuning — when to use which', url: 'https://www.pinecone.io/learn/retrieval-augmented-generation/' }] },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { id: 'w19-fri', title: 'Fri — RAG evaluation: faithfulness, answer relevance, context precision', hours: 1.5, priority: 'must-know', weekNumber: 19, resources: [{ type: 'doc', label: 'RAGAS: Getting Started — your first eval', url: 'https://docs.ragas.io/en/stable/getstarted/index.html' }, { type: 'doc', label: 'RAGAS: Core metrics (faithfulness, answer relevance, context precision)', url: 'https://docs.ragas.io/en/stable/concepts/metrics/index.html' }] },
    ...
    topics: [
      {
        ...
        subtopics: [
          { id: 'w25-mon', title: 'Mon — Two pointers pattern', hours: 1.5, priority: 'must-know', weekNumber: 25, resources: [{ type: 'youtube', label: 'NeetCode: Valid Palindrome (two pointers)', url: 'https://www.youtube.com/watch?v=jJXJ16kPFWg' }, { type: 'youtube', label: 'NeetCode: Two Sum II — Sorted Array', url: 'https://www.youtube.com/watch?v=cQ1Oz4ckceM' }, { type: 'youtube', label: 'NeetCode: 3Sum', url: 'https://www.youtube.com/watch?v=jzZsG8n2R9A' }] },
          { id: 'w25-tue', title: 'Tue — Sliding window', hours: 1.5, priority: 'must-know', weekNumber: 25, resources: [{ type: 'youtube', label: 'NeetCode: Best Time to Buy and Sell Stock (sliding window)', url: 'https://www.youtube.com/watch?v=1pkOgXD63yU' }, { type: 'youtube', label: 'NeetCode: Longest Substring Without Repeating Characters', url: 'https://www.youtube.com/watch?v=wiGpQwVHdE0' }, { type: 'youtube', label: 'NeetCode: Longest Repeating Character Replacement', url: 'https://www.youtube.com/watch?v=gqXU1UyA8pk' }] },
          { id: 'w25-wed', title: 'Wed — Hash maps / sets', hours: 1.5, priority: 'must-know', weekNumber: 25, resources: [{ type: 'youtube', label: 'NeetCode: Two Sum (hash map)', url: 'https://www.youtube.com/watch?v=KLlXCFG5TnA' }, { type: 'youtube', label: 'NeetCode: Group Anagrams', url: 'https://www.youtube.com/watch?v=vzdNOK2oB2E' }, { type: 'youtube', label: 'NeetCode: Contains Duplicate', url: 'https://www.youtube.com/watch?v=3OamzN90kPg' }] },
          { id: 'w25-thu', title: 'Thu — Prefix sum', hours: 1.5, priority: 'must-know', weekNumber: 25, resources: [{ type: 'youtube', label: 'NeetCode: Range Sum Query — Immutable (prefix sum)', url: 'https://www.youtube.com/watch?v=2pndAmo_sMA' }, { type: 'youtube', label: 'NeetCode: Subarray Sum Equals K', url: 'https://www.youtube.com/watch?v=fFVZt-6sgyo' }] },
          ...
          { id: 'w25-sun', title: 'Sun — Blind 75 progress — aim for 15 problems done', hours: 3, priority: 'must-know', weekNumber: 25, resources: [{ type: 'doc', label: 'NeetCode Blind 75 — filtered problem list', url: 'https://neetcode.io/practice?tab=blind75' }, { type: 'youtube', label: 'NeetCode: Blind 75 walkthrough playlist', url: 'https://www.youtube.com/playlist?list=PLot-Xpze53ldVwtstag2TL4HQhAnC8ATf' }] },
        ],
      },
      {
        id: 'w26',
        ...
        subtopics: [
          { id: 'w26-mon', title: 'Mon — Binary trees: DFS (pre/in/post), BFS', hours: 1.5, priority: 'must-know', weekNumber: 26, resources: [{ type: 'youtube', label: 'NeetCode: Invert Binary Tree (BFS/DFS basics)', url: 'https://www.youtube.com/watch?v=OnSn2XEQ4MY' }, { type: 'youtube', label: 'NeetCode: Maximum Depth of Binary Tree', url: 'https://www.youtube.com/watch?v=hTM3phVI6YQ' }, { type: 'youtube', label: 'NeetCode: Diameter of Binary Tree', url: 'https://www.youtube.com/watch?v=bkxqA8Rfv04' }] },
          { id: 'w26-tue', title: 'Tue — BST operations + LCA', hours: 1.5, priority: 'must-know', weekNumber: 26, resources: [{ type: 'youtube', label: 'NeetCode: Validate Binary Search Tree', url: 'https://www.youtube.com/watch?v=s6ATEkipzow' }, { type: 'youtube', label: 'NeetCode: Lowest Common Ancestor of a BST', url: 'https://www.youtube.com/watch?v=gs2LMfuOR9k' }, { type: 'youtube', label: 'NeetCode: Kth Smallest Element in BST', url: 'https://www.youtube.com/watch?v=5LUXSvjmGCw' }] },
          { id: 'w26-wed', title: 'Wed — Graphs: BFS/DFS, connected components', hours: 1.5, priority: 'must-know', weekNumber: 26, resources: [{ type: 'youtube', label: 'NeetCode: Number of Islands (BFS/DFS)', url: 'https://www.youtube.com/watch?v=pV2kpPD66nE' }, { type: 'youtube', label: 'NeetCode: Clone Graph', url: 'https://www.youtube.com/watch?v=mQeF6bN8hMk' }, { type: 'youtube', label: 'NeetCode: Pacific Atlantic Water Flow', url: 'https://www.youtube.com/watch?v=s-VkcjHqkGI' }] },
          { id: 'w26-thu', title: 'Thu — Topological sort, Union-Find', hours: 1.5, priority: 'must-know', weekNumber: 26, resources: [{ type: 'youtube', label: 'NeetCode: Course Schedule (topological sort)', url: 'https://www.youtube.com/watch?v=EgI5nU9etnU' }, { type: 'youtube', label: 'NeetCode: Redundant Connection (Union-Find)', url: 'https://www.youtube.com/watch?v=FXWRE67PLL0' }] },
          { id: 'w26-fri', title: 'Fri — DP basics: climbing stairs, coin change', hours: 1.5, priority: 'must-know', weekNumber: 26, resources: [{ type: 'youtube', label: 'NeetCode: Climbing Stairs (1-D DP intro)', url: 'https://www.youtube.com/watch?v=Y0lT9Fck7qI' }, { type: 'youtube', label: 'NeetCode: Coin Change', url: 'https://www.youtube.com/watch?v=H9bfqozjoqs' }] },
          { id: 'w26-sat', title: 'Sat — DP intermediate: LIS, edit distance', hours: 3, priority: 'must-know', weekNumber: 26, resources: [{ type: 'youtube', label: 'NeetCode: Longest Increasing Subsequence (LIS)', url: 'https://www.youtube.com/watch?v=cjWnW0hdF1Y' }, { type: 'youtube', label: 'NeetCode: Edit Distance', url: 'https://www.youtube.com/watch?v=XYi2-LPrwm4' }, { type: 'youtube', label: 'NeetCode: Longest Common Subsequence', url: 'https://www.youtube.com/watch?v=Ua0GhsJSlWM' }] },
          { id: 'w26-sun', title: 'Sun — Heaps: top-K, merge K sorted lists', hours: 3, priority: 'must-know', weekNumber: 26, resources: [{ type: 'youtube', label: 'NeetCode: Kth Largest Element in an Array (heap top-K)', url: 'https://www.youtube.com/watch?v=XEmy13g1Qxc' }, { type: 'youtube', label: 'NeetCode: Merge K Sorted Lists', url: 'https://www.youtube.com/watch?v=q5a5OiGbT6Q' }, { type: 'youtube', label: 'NeetCode: Find Median from Data Stream', url: 'https://www.youtube.com/watch?v=itmhHWaHupI' }] },
        ],
      },
      {
        id: 'w27',
      ...
      },
      {
        ...
        subtopics: [
          { id: 'w29-mon', title: 'Mon — Backtracking: subsets, permutations, N-queens', hours: 1.5, priority: 'must-know', weekNumber: 29, resources: [{ type: 'youtube', label: 'NeetCode: Subsets (backtracking template)', url: 'https://www.youtube.com/watch?v=REOH22Xwdkk' }, { type: 'youtube', label: 'NeetCode: Permutations', url: 'https://www.youtube.com/watch?v=s7AvT7cGdSo' }, { type: 'youtube', label: 'NeetCode: N-Queens', url: 'https://www.youtube.com/watch?v=Ph95IHmRp5M' }] },
          { id: 'w29-tue', title: 'Tue — Greedy: interval scheduling, jump game', hours: 1.5, priority: 'must-know', weekNumber: 29, resources: [{ type: 'youtube', label: 'NeetCode: Jump Game (greedy)', url: 'https://www.youtube.com/watch?v=Yan0cv2cLy8' }, { type: 'youtube', label: 'NeetCode: Non-overlapping Intervals (interval scheduling)', url: 'https://www.youtube.com/watch?v=nONCGxWoUfM' }] },
          { id: 'w29-wed', title: 'Wed — Binary search variants', hours: 1.5, priority: 'must-know', weekNumber: 29, resources: [{ type: 'youtube', label: 'NeetCode: Binary Search (template)', url: 'https://www.youtube.com/watch?v=s4DPM8ct1pI' }, { type: 'youtube', label: 'NeetCode: Find Minimum in Rotated Sorted Array', url: 'https://www.youtube.com/watch?v=nIVW4P8b1VA' }, { type: 'youtube', label: 'NeetCode: Search in Rotated Sorted Array', url: 'https://www.youtube.com/watch?v=U8XENwh8Oy8' }] },
          { id: 'w29-thu', title: 'Thu — Trie problems', hours: 1.5, priority: 'must-know', weekNumber: 29, resources: [{ type: 'youtube', label: 'NeetCode: Implement Trie (Prefix Tree)', url: 'https://www.youtube.com/watch?v=oobqoCJlHA0' }, { type: 'youtube', label: 'NeetCode: Word Search II (Trie + DFS)', url: 'https://www.youtube.com/watch?v=asbcE9mZz_U' }] },
          { id: 'w29-fri', title: 'Fri — Bit manipulation basics', hours: 1.5, priority: 'must-know', weekNumber: 29, resources: [{ type: 'youtube', label: 'NeetCode: Single Number (XOR trick)', url: 'https://www.youtube.com/watch?v=qMPX1AOa83k' }, { type: 'youtube', label: 'NeetCode: Number of 1 Bits (Hamming weight)', url: 'https://www.youtube.com/watch?v=5Km3utixwZs' }, { type: 'youtube', label: 'NeetCode: Counting Bits', url: 'https://www.youtube.com/watch?v=RyBM56RIWrM' }] },
          { id: 'w29-sat', title: 'Sat — Hard DP: knapsack, LCS', hours: 3, priority: 'must-know', weekNumber: 29, resources: [{ type: 'youtube', label: 'NeetCode: 0/1 Knapsack pattern (Partition Equal Subset Sum)', url: 'https://www.youtube.com/watch?v=IsvocB5BJhw' }, { type: 'youtube', label: 'NeetCode: Longest Common Subsequence (2-D DP)', url: 'https://www.youtube.com/watch?v=Ua0GhsJSlWM' }, { type: 'youtube', label: 'NeetCode: Unique Paths', url: 'https://www.youtube.com/watch?v=IlEsdxuD4lY' }] },
    ...
    topics: [
      ...
      },
      {
        ...
        subtopics: [
          ...
          { id: 'w34-wed', title: 'Wed — DeepEval + Promptfoo for systematic testing', hours: 1.5, priority: 'must-know', weekNumber: 34, resources: [{ type: 'doc', label: 'DeepEval: Quickstart — write your first LLM eval', url: 'https://docs.confident-ai.com/docs/getting-started' }, { type: 'doc', label: 'Promptfoo: Getting Started — prompt regression testing', url: 'https://www.promptfoo.dev/docs/getting-started/' }] },
      ...
      },
      {
        ...
        subtopics: [
          { id: 'w38-mon', title: 'Mon — DSA: 1 medium problem to stay sharp', hours: 1, priority: 'must-know', weekNumber: 38, resources: [{ type: 'doc', label: 'LeetCode: Medium problems filtered', url: 'https://leetcode.com/problemset/?difficulty=MEDIUM' }] },
          ...
          { id: 'w38-thu', title: 'Thu — DSA: 1 medium problem + ML flashcards', hours: 1.5, priority: 'must-know', weekNumber: 38, resources: [{ type: 'doc', label: 'LeetCode: Medium problems filtered', url: 'https://leetcode.com/problemset/?difficulty=MEDIUM' }] },
      ...
      },
      {
        ...
        subtopics: [
          ...
          { id: 'w39-tue', title: 'Tue — Track B — ML Platform / MLOps: Kubernetes, Ray, feature stores (Feast)', hours: 1.5, priority: 'must-know', weekNumber: 39, resources: [{ type: 'doc', label: 'Feast: Quickstart — set up your first feature store', url: 'https://docs.feast.dev/getting-started/quickstart' }] },
